...
- V1.77 `TrackingCommand` JSON parser、實體相機 `zoom_factor`、dead zone、速度上限、smoothing。
- 真實 WebSocket Client、V1.77 URL 輸入、自動連線／重連、30 FPS JPEG 相機串流與 500 ms timeout STOP。
